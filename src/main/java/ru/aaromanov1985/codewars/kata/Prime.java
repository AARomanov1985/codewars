...
public class Prime {
    ...
    /**
     * Define a function that takes an integer argument and returns logical Define a function that takes an integer
     * argument and returns logical value true or false depending on if the integer is a prime.
     *
     ...
     * There are no fancy optimizations required, but still
     * the most trivial solutions might time out. Try to find a solution which does not loop all the way up to n.
     */
